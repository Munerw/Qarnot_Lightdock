...
if __name__ == "__main__":
	...
	#ellipsoid_data_file = "%s%s" % (DEFAULT_LIGHTDOCK_PREFIX % ligand.structure_file_names[0],DEFAULT_ELLIPSOID_DATA_EXTENSION)
        ellipsoid_data_file = "%s%s" % (ligand.structure_file_names[0],
                                        DEFAULT_ELLIPSOID_DATA_EXTENSION)
