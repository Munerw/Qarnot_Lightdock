...
static PyMethodDef __pyx_mdef_2j1_1j1 = {"j1", (PyCFunction)__pyx_pw_2j1_1j1, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 */
  ...
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(2, 0, 2, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_j1_pyx, __pyx_n_s_j1, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initj1(void); /*proto*/
PyMODINIT_FUNC initj1(void)
#else
PyMODINIT_FUNC PyInit_j1(void); /*proto*/
PyMODINIT_FUNC PyInit_j1(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_j1(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init j1", 0, __pyx_lineno, __pyx_filename);
    }
